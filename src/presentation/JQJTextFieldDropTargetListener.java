...
import presentation.JQDragAndDropQuestionScreen;
 ...
 * 
 */
public class JQJTextFieldDropTargetListener implements DropTargetListener {

	private JTextField jtf = null;
	
	JQJTextFieldDropTargetListener(JTextField parent) {
		jtf = parent; 
	}

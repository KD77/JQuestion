...
public class JQEAboutDialog extends JDialog {
	...
	private JQEAboutDialog() {
		super();

		setTitle("About logic.JQuestions Editor");
        ...
        // Create labels.		
		JLabel jqString = new JLabel("logic.JQuestions Editor");
	...
	private static class SingletonHolder {
		private static final JQEAboutDialog INSTANCE = new JQEAboutDialog();
	}

	public static JQEAboutDialog getInstance() {

...
public class JQDragAndDropQuestionScreen extends JQQuestionScreen {
	 ...
	 * @param buttonPanel
	 */
	JQDragAndDropQuestionScreen(JPanel headerPanel, JPanel buttonPanel) {
	...
	public void createDnDPanel() {
		...
		for (int i = 0; i < MAX_NUMBER_OF_OPTIONS; i++) {
			...
			jtf.setToolTipText("Double-click to drag and drop text into boxes.");
	...
	private void codeFieldMousePressed(JTextField jtf) {

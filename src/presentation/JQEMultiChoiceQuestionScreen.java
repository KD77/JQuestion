...
import presentation.JQEEditorQuestionScreen;
 ...
 * @see JQEEditorQuestionScreen
 * @see JQEDragAndDropQuestionScreen
 * 
 */
@SuppressWarnings("serial")
public class JQEMultiChoiceQuestionScreen extends JQEEditorQuestionScreen {
	
	// logic.Question panels
	private JTextPane mainTextPane;
	private JTextArea questionTextArea;

	// Main GUI components.
	private final List<JLabel> labels = new ArrayList<JLabel>();
	private final List<JCheckBox> answerBox = new ArrayList<JCheckBox>();
    private final List<JScrollPane> scrollPanes = new ArrayList<JScrollPane>();
    private final List<JPanel> choicePanels = new ArrayList<JPanel>();
	private final List<JTextArea> answerText = new ArrayList<JTextArea>();
	private final List<StringBuilder> explainPossibleAnswers = new ArrayList<StringBuilder>();
     ...
     * @param buttonPanel
     */    
	JQEMultiChoiceQuestionScreen(JPanel headerPanel, JPanel buttonPanel) {
	...
	public void createMultiChoicePanel() {
		...
		numPossAnswers.addChangeListener(new JQESpinnerListener(this));
		...
		for (int i=0; i<MAX_NUMBER_OF_OPTIONS; i++) {
			...
			explainButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					explainButtonActionPerformed(index);
				}
			});
	 ...
	 */
	private void explainButtonActionPerformed(int i) {
		...
		String response = MultiLineTextInputDialog.showInputDialog("Enter some explanation text",
				sb.toString(), true);
	 ...
	 * create a new logic.Question record.
	 * 
	 ...
	 * @return - new logic.Question object.
	 */

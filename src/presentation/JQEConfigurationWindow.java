...
public class JQEConfigurationWindow extends JDialog {
    private QuestionpoolAndsetValue q;
     ...
     */
    public JQEConfigurationWindow(Object parent) {
        qPool = null;

        initComponents();

        IQuestion qPool = new QuestionpoolAndsetValue();
        qPool.getQuestionpoolAndsetValue(parent);
    ...
    private void okButtonActionPerformed() {
        // Get the logic.Question Pool instance.
        qPool = jqEditor.getQuestionPool();

        // Save the values from the Conf Window back to the logic.Question Pool.
    ...
    private void timedButtonItemStateChanged() {
        if (timedButton.isSelected()) {

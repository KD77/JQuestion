 ...
 * @see JQuestionsGUI
 */
public class JQReportSummaryWindow extends JDialog implements Printable {

    // Reference to main GUI
    private final SummaryGet jqg;
    ...
    // ImageIcons
    private final ImageIcon greenTick;
    private final ImageIcon redCross;
     ...
     * @param parent
     */
    public JQReportSummaryWindow(SummaryGet parent) {
        jqg = parent;

        jQUserAnswers = jqg.getUserAnswers();
        questionIds = jqg.getQuestionIds();

        questionsToAnswer = questionIds.size();

        greenTick = JQImageLibrary.getGreenTickIcon();
        redCross = JQImageLibrary.getRedCrossIcon();
        ...
        printButton.setVisible(jqg.getDisplayPrintOption() == true);
    ...
    /**
     * Exit the logic.JQuestions application.
     */
     ...
     */
    private void returnToQuestionsButtonActionPerformed() {
    ...
    public void updateDisplay() {
        ...
        for (int i = 0; i < questionsToAnswer; i++) {
            ...
            JQUserAnswer answer = jQUserAnswers.get(index);
    ...
    private void initComponents() {
        ...
        //======== this ========
        setTitle("logic.JQuestions - Report Summary");
        setModal(true);
        ...
        returnToQuestionsButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                returnToQuestionsButtonActionPerformed();
            }
        });
        //                                                    x  y  w  h  wtx  wty  anchor                   fill                              T   L   B   R padx pady

 ...
 */
public class JQETextDropTargetListener implements DropTargetListener {

    // The main question panel.
    private final JTextPane textPane;

    public JQETextDropTargetListener(JTextPane tp) {
        textPane = tp;
    }
    ...
    /**
     * <p>
     * Given a text string this method constructs a 'standard', logic.JQuestions

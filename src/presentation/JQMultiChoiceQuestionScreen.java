 ...
 * defined in them presentation.JQuestionsEditor. No editing functions are
 * defined.
 *
 * @author Ken Williams <jquestions@truerandomness.com>
 * @see JQQuestionScreen
 * @see JQDragAndDropQuestionScreen
 */
@SuppressWarnings("serial")
public class JQMultiChoiceQuestionScreen extends JQQuestionScreen {
     ...
     * @param buttonPanel
     */
    JQMultiChoiceQuestionScreen(JPanel headerPanel, JPanel buttonPanel) {
     ...
     * @param question
     */
    public void displayQuestionRecord(Question question, JQUserAnswer currentAnswer) {
     ...
     */
    protected boolean isCorrect(Question question) {
        boolean selected;
        boolean contains;

...
public class JQAboutDialog extends JDialog {
	 ...
	 */
	private JQAboutDialog() {
		super();

		setTitle("About logic.JQuestions");
		...
		// Create the labels.
		JLabel jqString = new JLabel("logic.JQuestions");
	...
	private static class SingletonHolder {
		private static final JQAboutDialog INSTANCE = new JQAboutDialog();

	}
	public static JQAboutDialog getInstance() {

 ...
 * in the presentation.JQuestionsEditor. If the user may change the configuration
...
public class JQConfigurationWindow extends JDialog {
     ...
     */
    public JQConfigurationWindow(Object parent) {
        qPool = null;

        initComponents();

        // Get the logic.Question Pool.

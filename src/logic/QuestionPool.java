...
/**
 * Each .jqs file contains one logic.QuestionPool. Each logic.QuestionPool contains a list
 * of one or more logic.Question objects. This class stores the details and methods
 * associated with each logic.QuestionPool.
 * <p>
 * The logic.Question 'Pool' is essentially a List.
 * In logic.JQuestions the questions are shuffled and displayed in random order.
 * In logic.JQuestions Editor there is no shuffling and questions and answers are
 ...
 * These are also stored in with the logic.QuestionPool.
 *
...
public class QuestionPool {
    ...
    // Current Configuration Settings for this logic.Question pool.
    ...
    /**
     * @param newQuestion - the new logic.Question to be added to the pool.
    ...
    /**
     * @param theQuestion - the logic.Question to be deleted from the pool.
     * @return result - did the add succeed or fail ?
     */
     ...
     *
     * @param index
     * @return The logic.Question record return null if a problem.
     */
    ...
    private void initConfigurationSettings() {
        ...
        descriptionText = "This is a pool of questions.";

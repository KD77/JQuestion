 ...
 * associated with each logic.Question.
 * <p>
 * Note that a question may be currently one of two types - MULTI_CHOICE or
 * DRAG_N_DROP (as defined by the enum data.QuestionType). It should be easy to
...
public class Question {
     ...
     * <p>
     * For each logic.Question, answers are randomly shuffled each time
     * logic.JQuestions is started to prevent the user from 'visually'
    ...
    public void shuffleAnswers() {
        ...
        } else if (questionType == QuestionType.DRAG_N_DROP) {
     ...
     * new location of each shuffled data.PossibleAnswer.
     */
    ...
    /**
     * Return a String representation of the logic.Question.
     */

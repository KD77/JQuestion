...
//-----------------------------------------------------------------------
/**
 * <p>logic.ImageUtils instances should NOT be constructed in standard programming.
 * The methods have been declared as <code>static</code> therefore, the class 
 * methods should be used as <code>logic.ImageUtils.getArrayFromImage(image, width, height)
 * </code>.</p>
 * 

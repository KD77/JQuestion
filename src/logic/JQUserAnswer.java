...
public class JQUserAnswer {
    ...
    /**
     * Construct a UserAnswer object for a given logic.Question object
     * and its index poosition.
     *
     * @param q     - The logic.Question object.
     * @param index - The index position of the logic.Question.
     */

    public JQUserAnswer(Question q, int index) {
        question = q;
        questionIndex = index;
